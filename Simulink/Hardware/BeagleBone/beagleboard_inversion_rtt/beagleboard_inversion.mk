# File name: beagleboard_inversion.mk
# Autogenerated on: 09-Aug-2013 10:26:02
# Copyright 2009-2012 The MathWorks, Inc.
#
# Model: BEAGLEBOARD_INVERSION
# Template: gmake 
...
EMPTY                :=
SPACE                := $(EMPTY) $(EMPTY)
MODEL_NAME           := beagleboard_inversion
...
MATLAB_ROOT_RELATIVE := C:\Program Files\MATLAB\R2013a\#MATLAB_ROOT_RELATIVE_END
...
SOURCE_FILES        := $(call FORMAT_PATH,.\sdl_video_display.c) $(call FORMAT_PATH,.\v4l2_capture.c) $(call FORMAT_PATH,.\v4l2_capture_linux.c) $(call FORMAT_PATH,.\linuxUDP.c) $(call FORMAT_PATH,.\ext_svr.c) $(call FORMAT_PATH,.\ext_work.c) $(call FORMAT_PATH,.\rtiostream_interface.c) $(call FORMAT_PATH,.\updown.c) $(call FORMAT_PATH,.\rtiostream_tcpip.c) $(call FORMAT_PATH,.\rtiostream_utils.c) $(call FORMAT_PATH,.\beagleboard_inversion.c) $(call FORMAT_PATH,.\beagleboard_inversion_data.c) $(call FORMAT_PATH,.\ert_main.c)
HEADER_FILES        := $(call FORMAT_PATH,C:\Program Files\MATLAB\R2013a\rtw\c\src\ext_mode\common\ext_svr.h) $(call FORMAT_PATH,C:\Program Files\MATLAB\R2013a\rtw\c\src\ext_mode\common\ext_work.h) $(call FORMAT_PATH,C:\Program Files\MATLAB\R2013a\rtw\c\src\ext_mode\common\updown.h) $(call FORMAT_PATH,C:\Program Files\MATLAB\R2013a\toolbox\coder\rtiostream\src\utils\rtiostream_utils.h) $(call FORMAT_PATH,.\beagleboard_inversion.h)
LIBRARY_FILES       := 
...
COMPILER_CODEGEN_ARGS := -I"C:/MATLAB/SupportPackages/R2013a/linux/blocks/sfcn/include" -I"D:/Design/Matlab/Simulink/Hardware/BeagleBone/beagleboard_inversion_rtt" -I"D:/Design/Matlab/Simulink/Hardware/BeagleBone" -I"C:/MATLAB/SupportPackages/R2013a/beagleboard/beagleboarddemos" -I"C:/Program Files/MATLAB/R2013a/extern/include" -I"C:/Program Files/MATLAB/R2013a/simulink/include" -I"C:/Program Files/MATLAB/R2013a/rtw/c/src" -I"C:/Program Files/MATLAB/R2013a/rtw/c/src/ext_mode/common" -I"C:/Program Files/MATLAB/R2013a/rtw/c/ert" -I"C:/Program Files/MATLAB/R2013a/toolbox/coder/rtiostream/src/utils" -I"C:/MATLAB/SupportPackages/R2013a/linux/blocks/sfcn/src" -I"C:/Program Files/MATLAB/R2013a/toolbox/shared/dspblks/extern/include" -O3 -mcpu=cortex-a8 -mfpu=neon -D"MODEL=beagleboard_inversion" -D"NUMST=1" -D"NCSTATES=0" -D"HAVESTDIO=" -D"ON_TARGET_WAIT_FOR_START=1" -D"ONESTEPFCN=0" -D"EXT_MODE=1" -D"TERMFCN=1" -D"MAT_FILE=0" -D"MULTI_INSTANCE_CODE=0" -D"INTEGER_CODE=0" -D"MT=0" -D"CLASSIC_INTERFACE=0" -D"TID01EQ=0" -D"_USE_TARGET_UDP_=" -D"_RUNONTARGETHARDWARE_BUILD_=" -D"_OMAP3_GPIO_MUX_="
