# File name: beagleboard_communication.mk
# Autogenerated on: 02-Aug-2013 23:09:52
# Copyright 2009-2012 The MathWorks, Inc.
#
# Model: BEAGLEBOARD_COMMUNICATION
# Template: gmake 
...
EMPTY                :=
SPACE                := $(EMPTY) $(EMPTY)
MODEL_NAME           := beagleboard_communication
...
SOURCE_FILES        := $(call FORMAT_PATH,.\linuxUDP.c) $(call FORMAT_PATH,.\HostLib_Network.c) $(call FORMAT_PATH,.\HostLib_rtw.c) $(call FORMAT_PATH,.\beagleboard_communication.c) $(call FORMAT_PATH,.\beagleboard_communication_data.c) $(call FORMAT_PATH,.\ert_main.c)
HEADER_FILES        := $(call FORMAT_PATH,.\beagleboard_communication.h)
LIBRARY_FILES       := 
...
COMPILER_CODEGEN_ARGS := -I"C:/Program Files/MATLAB/R2013a/toolbox/shared/dspblks/extern/include" -I"D:/Design/Matlab/Simulink/Hardware/BeagleBone/beagleboard_communication_rtt" -I"D:/Design/Matlab/Simulink/Hardware/BeagleBone" -I"C:/MATLAB/SupportPackages/R2013a/beagleboard/beagleboarddemos" -I"C:/Program Files/MATLAB/R2013a/extern/include" -I"C:/Program Files/MATLAB/R2013a/simulink/include" -I"C:/Program Files/MATLAB/R2013a/rtw/c/src" -I"C:/Program Files/MATLAB/R2013a/rtw/c/src/ext_mode/common" -I"C:/Program Files/MATLAB/R2013a/rtw/c/ert" -O3 -mcpu=cortex-a8 -mfpu=neon -D"MODEL=beagleboard_communication" -D"NUMST=1" -D"NCSTATES=0" -D"HAVESTDIO=" -D"ONESTEPFCN=0" -D"TERMFCN=1" -D"MAT_FILE=0" -D"MULTI_INSTANCE_CODE=0" -D"INTEGER_CODE=0" -D"MT=0" -D"CLASSIC_INTERFACE=0" -D"TID01EQ=0" -D"_USE_TARGET_UDP_=" -D"_RUNONTARGETHARDWARE_BUILD_=" -D"_OMAP3_GPIO_MUX_="
