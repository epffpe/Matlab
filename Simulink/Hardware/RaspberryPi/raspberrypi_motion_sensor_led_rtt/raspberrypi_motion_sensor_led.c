...
void raspberrypi_motion_sensor_led_initialize(void)
{
  ...
  /* External mode info */
  raspberrypi_motion_sensor_le_M->Sizes.checksums[0] = (2196032474U);
  raspberrypi_motion_sensor_le_M->Sizes.checksums[1] = (709268434U);
  raspberrypi_motion_sensor_le_M->Sizes.checksums[2] = (2318404783U);
  raspberrypi_motion_sensor_le_M->Sizes.checksums[3] = (1446614972U);
